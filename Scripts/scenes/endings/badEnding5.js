...
var scenes;
(function (scenes) {
    var BadEnd5 = (function (_super) {
        __extends(BadEnd5, _super);
        function BadEnd5() {
            _super.call(this);
            //set the background image
            this._bgImage = new createjs.Bitmap(assets.getResult("BadEnd5"));
            this.addChild(this._bgImage);
        }
        BadEnd5.prototype.start = function () {
        ...
        BadEnd5.prototype._resetButtonClick = function (event) {
    ...
    scenes.BadEnd5 = BadEnd5;
})(scenes || (scenes = {}));
//# sourceMappingURL=badending5.js.map