...
var scenes;
(function (scenes) {
    var BadEnd4 = (function (_super) {
        __extends(BadEnd4, _super);
        function BadEnd4() {
            _super.call(this);
            //set the background image
            this._bgImage = new createjs.Bitmap(assets.getResult("BadEnd4"));
            this.addChild(this._bgImage);
        }
        BadEnd4.prototype.start = function () {
        ...
        BadEnd4.prototype._resetButtonClick = function (event) {
    ...
    scenes.BadEnd4 = BadEnd4;
})(scenes || (scenes = {}));
//# sourceMappingURL=badending4.js.map