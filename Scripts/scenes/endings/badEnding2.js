...
var scenes;
(function (scenes) {
    var BadEnd2 = (function (_super) {
        __extends(BadEnd2, _super);
        function BadEnd2() {
            _super.call(this);
            //set the background image
            this._bgImage = new createjs.Bitmap(assets.getResult("BadEnd2"));
            this.addChild(this._bgImage);
        }
        BadEnd2.prototype.start = function () {
        ...
        BadEnd2.prototype._resetButtonClick = function (event) {
    ...
    scenes.BadEnd2 = BadEnd2;
})(scenes || (scenes = {}));
//# sourceMappingURL=badending2.js.map